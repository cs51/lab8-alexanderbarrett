...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let current_id = new_id () in 
    let current_waiter = { id = current_id ; action = listener } in
    evt := current_waiter :: (!evt) ; 
    current_id ;;
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    let rec helper (lst : 'a waiter list) : unit = 
      match lst with 
      | [] -> () 
      | hd :: tl -> hd.action arg ; helper tl
    in helper (!evt) ;; 
...
WEvent.remove_listener newswire fNN_id ;;
WEvent.remove_listener newswire bF_id ;;
